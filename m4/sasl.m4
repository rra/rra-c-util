...
dnl RRA_LIB_SASL_SWITCH.  Defines HAVE_SASL and sets rra_use_SASL to true if
...
dnl Defines HAVE_SASL and sets rra_use_SASL to true if the Cyrus SASL library
